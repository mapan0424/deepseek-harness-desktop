  ...
  invocations: [
    {
      ...
      parameters: [],
      result: { mode: "strict", typeSymbol: "harness-channel-dingtalk#GatewayConfig", schema: getResultSchema, create: () => getResultSchema },
    },
    {
      ...
      parameters: [
        {
          ...
          wire: "payload",
          source: "json",
          codec: { mode: "strict", typeSymbol: "harness-channel-dingtalk#SetPayload", schema: setPayloadSchema, create: () => setPayloadSchema },
        },
      ],
      result: { mode: "strict", typeSymbol: "harness-channel-dingtalk#SetResult", schema: setResultSchema, create: () => setResultSchema },
    },
  ],
...
export function apply(ctx, config) {
  ...
  const scope = resolveSettingsScope(ctx, "dingtalk", baseDefaults, {
