  ...
  invocations: [
    {
      ...
      parameters: [],
      result: { mode: "strict", typeSymbol: "harness-channel-imessage#GatewayConfig", schema: getResultSchema, create: () => getResultSchema },
    },
    {
      ...
      parameters: [
        {
          ...
          wire: "payload",
          source: "json",
          codec: { mode: "strict", typeSymbol: "harness-channel-imessage#SetPayload", schema: setPayloadSchema, create: () => setPayloadSchema },
        },
      ],
      result: { mode: "strict", typeSymbol: "harness-channel-imessage#SetResult", schema: setResultSchema, create: () => setResultSchema },
    },
  ],
