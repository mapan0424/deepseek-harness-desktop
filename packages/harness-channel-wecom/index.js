  ...
  invocations: [
    {
      ...
      parameters: [],
      result: { mode: "strict", typeSymbol: "harness-channel-wecom#GatewayConfig", schema: getResultSchema, create: () => getResultSchema },
    },
    {
      ...
      parameters: [
        {
          ...
          wire: "payload",
          source: "json",
          codec: { mode: "strict", typeSymbol: "harness-channel-wecom#SetPayload", schema: setPayloadSchema, create: () => setPayloadSchema },
        },
      ],
      result: { mode: "strict", typeSymbol: "harness-channel-wecom#SetResult", schema: setResultSchema, create: () => setResultSchema },
    },
  ],
