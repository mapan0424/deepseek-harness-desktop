  ...
  invocations: [
    {
      ...
      parameters: [],
      result: { mode: "strict", typeSymbol: "harness-channel-feishu#GatewayConfig", schema: getResultSchema, create: () => getResultSchema },
    },
    {
      ...
      parameters: [
        {
          ...
          wire: "payload",
          source: "json",
          codec: { mode: "strict", typeSymbol: "harness-channel-feishu#SetPayload", schema: setPayloadSchema, create: () => setPayloadSchema },
        },
      ],
      result: { mode: "strict", typeSymbol: "harness-channel-feishu#SetResult", schema: setResultSchema, create: () => setResultSchema },
    },
  ],
...
export function apply(ctx, config) {
  ...
  const scope = resolveSettingsScope(ctx, "feishu", baseDefaults, {
