// npm treats a prerelease range such as ^0.1.6-alpha.2 as eligible for a later
// prerelease. Keep the verified package closure exact so a clean install
// cannot produce a mixed runtime when a newer prerelease is published.
export const dshRuntimePackageNames = [
  "@deepseek-ai/dsh",
  "@deepseek-ai/dsh-acp",
...
export function pinnedDshRuntimeDependencies(version) {
  return Object.fromEntries(dshRuntimePackageNames.map((name) => [name, version]));
}
