...
const dshVersion = "0.1.5-alpha.1";
...
await pruneBundledPnpmNativeModules(runtimeRoot, "darwin-x64");
...
function assertIntelNatives() {
  const required = [
    ...
    join(runtimeRoot, "node_modules", "@deepseek-ai", "node-addon-system-darwin-x64", "bin", "system.node"),
  ];
